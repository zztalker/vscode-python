...
const deprecatedFeatures: DeprecatedFeatureInfo[] = [
    ...
    },
    {
        ...
        message: 'The setting \'python.autoComplete.preloadModules\' is deprecated, please consider using the new Language Server (\'python.languageServer = "microsoft"\').',        moreInfoUrl: 'https://github.com/Microsoft/vscode-python/issues/1704',
