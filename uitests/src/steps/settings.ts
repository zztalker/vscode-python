...
const translateType = (type: SettingType) =>
    type === 'user' ? ConfigurationTarget.Global : ConfigurationTarget.WorkspaceFolder;
...
Given('the {word} setting {string} is {word}', async function(
    type: SettingType,
    setting: string,
...
Given('the {word} setting {string} has the value {string}', async function(
    type: SettingType,
    setting: string,
    value: string
) {
...
Given('the {word} setting {string} has the value {int}', async function(
    type: SettingType,
    setting: string,
    value: number
) {
...
When('I {word} the {word} setting {string}', async function(
    change: EnabledOrDisabledOrRemove,
    type: SettingType,
    setting: string
) {
...
When('I update the {word} setting {string} with the value {string}', async function(
    type: SettingType,
    setting: string,
    value: string
) {
...
When('I update the {word} setting {string} with the value {int}', async function(
    type: SettingType,
    setting: string,
    value: number
) {
...
Then('the {word} setting {string} will be {word}', async function(
    type: SettingType,
    setting: string,
    enabledOrDisabled: EnabledOrDisabled
) {
...
Then('the workspace setting {string} contains the value {string}', async function(
    setting: string,
